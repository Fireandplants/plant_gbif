...
gbifnames = read_names(codecs.open("../query_names/gbif-occurrences-names.txt", "r", "utf-8"))
...
# outputs
gbif_lookup_file = "../query_names/gbif_tank_lookup_140606_unfiltered_jw95.txt"
